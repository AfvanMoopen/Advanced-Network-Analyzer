...
from hazzle_server_utils import get_hostname_from_target, get_ip_address_from_target
...
hazzle_app = Flask(__name__)
CORS(hazzle_app)

api = Api(hazzle_app, version="1.0", title="hazzle", description="hazzle for 52-weeks-of-python",
          default="hazzle", default_label="")
...
limiter = Limiter(hazzle_app, key_func=get_remote_address)
